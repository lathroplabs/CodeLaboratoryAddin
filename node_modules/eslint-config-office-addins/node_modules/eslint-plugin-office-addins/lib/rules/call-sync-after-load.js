...
module.exports = {
    ...
    meta: {
        type: "suggestion",
        messages: {
            callSyncAfterLoad: "Call context.sync() after calling load on '{{name}}' for property '{{loadValue}}' and before reading the property.",
        },
        docs: {
    ...
    create: function (context) {
        ...
        function findLoadBeforeSync() {
            ...
            apiReferences.forEach((apiReference) => {
                ...
                if (operation === "Load" &&
                    ...
                    const propertyName = load_1.getLoadArgument(identifier.parent);
                ...
                if (operation === "Read" && variable) {
                    const propertyName = utils_1.findPropertiesRead(reference.identifier.parent);
        ...
        return {
            Program() {
                apiReferences = utils_1.findOfficeApiReferences(context.getScope());
