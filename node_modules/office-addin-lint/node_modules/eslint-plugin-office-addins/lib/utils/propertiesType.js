...
const propertiesTypeJson = __importStar(require("./data/propertiesType.json"));
var PropertyType;
...
const navigationProperties = new Set(propertiesTypeJson.navigational);
const scalarProperties = new Set(propertiesTypeJson.scalar);
const ambiguousProperties = new Set(propertiesTypeJson.ambiguous);
